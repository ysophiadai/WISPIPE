...
;#
;# Last modification by Ivano Baronchelli May 8 2016
;
;###############################################################
;===================================================================================================
function cross_clean,rootname

; Wrong piece of code. Correction follows.
;root=strsplit(rootname,'_',/extract) ; ERROR when more than one "_"
;                                       symbol is in the file name
; I.B. Correction May 8 2016
root1=strsplit(rootname,'_',/extract)
IF N_ELEMENTS(root1) le 2 THEN root=strsplit(rootname,'_',/extract)
IF N_ELEMENTS(root1) gt 2 THEN BEGIN
  root=root1[0]
  FOR EL=1,n_elements(root1)-2 do root=root+'_'+root1[EL]
ENDIF

; end of I.B. correction May 8 2016
