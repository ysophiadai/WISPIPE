...
;# single images
;# 2015.05.06 udated for F140 only fields
;###############################################################
pro tweaksex_f140,field,path0
...
readcol,path+'DATA/DIRECT_GRISM/F140_clean.list',f140_drlist,format=('A')
...
;compared to F140W_orig_drz.fits
;*************************************
;   printf,6,'tweakreg.TweakReg("@direct_clean.list",catfile="direct_clean_catfile.list", refimage="'+f140_drlist[0]+'",refcat="'+f140_drlist[0]+'.coo",  wcsname="shift1", updateh
...
;   printf,6,'tweakreg.TweakReg("@direct_crclean.list",catfile="direct_crclean_catfile.list", refimage="'+f140_list[0]+'",refcat="'+f140_list[0]+'.coo", wcsname="shift1
