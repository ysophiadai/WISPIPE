...
IF J_OBS eq 'NO' and H_OBS eq 'NO' then begin
 print, 'ERROR: tweakprep_IB1.pro did not work properly'
 stop
ENDIF

IF H_OBS eq 'NO' then begin
 print, 'PROBABLE ERROR:'
 print, 'this is not an error if H observations (F140 or F160) are not present'
 print, 'The pipeline will not be stopped, but please check for possible errors'
ENDIF
