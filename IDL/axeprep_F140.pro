pro axeprep_F140,field,both=both, path0
...
if keyword_set(both) then begin
   ...
   readcol,path_data+'F140_clean.list',f140_list,format=('A')         
          ...
          ;****************************************** 
          sort_140=strarr(n_elements(g102_list))
          ...
          for i=0,n_elements(g102_list)-1 do begin       
              ...
              julian_102=JULDAY(date[1],date[2],date[0],time[0],time[1],time[2])
               ...
               ind_140=where(abs(julian_140 - julian_102) eq min(abs(julian_140 - julian_102)))
           ...
           f140_cat=strarr(n_elements(sort_140))
            ...
            for k=0,n_elements(sort_140)-1 do begin
               name_140=sort_140(k)
               tmp=strsplit(name_140,'.',/extract)
               root=tmp[0]
               f140_cat(k)=" "+root+'_1.cat '       
            endfor

     ;print axeprep file
     ;********************
     forprint,g102_list,f140_cat,sort_140,textout=path+'G102_axeprep.lis',/nocomment
