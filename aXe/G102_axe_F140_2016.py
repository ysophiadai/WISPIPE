...
def aXe_noback_drizzle_f140():
    ...
    # ============================
    print """
-->axeprep inlist="GRISM_axeprep.lis" configs="WFC3.IR.GRISM.test27s.conf"
             backgr="NO" mfwhm="2.0 norm="NO" histogram="NO"
    """
    time.sleep(5)
    iraf.axeprep(inlist=GRISM+"_axeprep.lis", configs="WFC3.IR."+GRISM+".test27s.conf",
    ...
    iraf.fixpix(images="@G102_clean.list//[1]%'",masks="/Users/ydai/WISPIPE/aXe/CONFIG/bp_mask_v5.pl",linterp=1000,cinterp="INDEF") 
    iraf.combine(input="@G102_clean.list//[1]%'",output="G102.fits",combine="median")
    ...
    # ============================
    print """
-->axecore inlist="GRISM_axesing.lis" configs="WFC3.IR.GRISM.test27s.conf" 
    ...
    """
    time.sleep(5)
    iraf.axecore(inlist=GRISM+"_axeprep.lis", configs="WFC3.IR."+GRISM+".test27s.conf", back="NO",
    ...
    #=============================== 
    print """
-->tdrzprep inlist="GRISM_axeprep.lis" configs="WFC3.IR.GRISM.test27s.conf"
            opt_extr="YES" back="NO"
    """
    time.sleep(5)
    iraf.drzprep(inlist=GRISM+"_axeprep.lis", configs="WFC3.IR."+GRISM+".test27s.conf",
                 opt_extr="YES", back="NO")
    ...
    # ==============================
    print """
-->axedrizzle inlist="GRISM_axeprep.lis" configs="WFC3.IR.GRISM.test27s.conf" opt_extr="YES"
               infwhm=4.0 outfwhm=3.0 back="NO" makespc="YES" opt_extr="YES"
    """
    time.sleep(5)
    iraf.axedrizzle(inlist=GRISM+"_axeprep.lis", configs="WFC3.IR."+GRISM+".test27s.conf", infwhm=9.0,
